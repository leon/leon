...
<Prose>
	<RandomImageBlock className="mb-8" images={[fieldImg, rainbowImg, winterImg]} title="About Me" />
	...
	<article>
		...
		<p>I hav always been interested in technology and got my first computer at the age of 12.</p>
		...
		<p>
			As soon as I got my first 56-kbit modem I was fascinated by the internet and spent a lot of
			time creating mix cds, playing with photoshop and wanting to know how everything worked.
		</p>
		<p>
		...
		<p>
			Somewhere along the way I figured out I was quite good at computers, always helping friends
			and family, and always wanting to learn more, I might be on to something here...
		</p>
		...
		<p>
			But after a year I dropped out and switched to a college focusing on media, graphic design,
			photo and music.
		</p>
		...
		<p>
			Here I became a certified network technician, learned c#, programmed a bunch of internal tools
			and worked with creating ads for the newspaper. In the night time I was hacking on javascript
			and getting into MooTools.
		</p>
		...
		<p>
			...
			As the years progressed we where building more advanced web apps and e-commerse solutions.
		</p>
		<p>
			But after 8 years being in the consulting business, always having to think about deadlines and
			money I felt it was time for a change.
		</p>

		<p>
			I found a new job working at <a href="https://www.wec360.com">wec360°</a> building a real estate
			visualization platform. It was fun to work with a SAAS product and I learned a lot about 3D, WebGL,
			and building a product from scratch.
		</p>
		<p>I worked my way up the ranks and I&apos;m now the CTO.</p>

		<p>
			It&apos;s hard to fathom that I&apos;ve been in the industry for over 20 years. It feels like
			I still have a lot to learn, but I guess that is never going to change.
		</p>
	</article>
</Prose>
